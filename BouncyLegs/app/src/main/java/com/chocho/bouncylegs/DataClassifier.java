...
import com.chocho.bouncylegs.classifierWrapper.ClassifierWrapper;
import com.chocho.bouncylegs.classifierWrapper.J48Wrapper;
import com.chocho.bouncylegs.sensorProc.DataInstanceList;
import com.chocho.bouncylegs.sensorProc.FeatureGenerator;
 ...
 */
public class DataClassifier implements MainActivity.DataAdaptor {
    ...
    public void slidingWindowData(String classLabel, DataInstanceList dlPressure) {
        ...
        HashMap<String, Float> featureMapPressure = FeatureGenerator.processPressure(dlPressure);
        ...
        int attributeSize = featureMapPressure.size() + 1;
        Instance instance = new Instance(attributeSize); // including class classLabel

        // Filling features for pressure
        for (String feature : featureMapPressure.keySet()) {
            float value = featureMapPressure.get(feature);
